...
var kolvo = 0;//количество убранных костей
var images1 = new Array(); //названия и порядок костей первой группы без расширения(.jpg)
var images2 = new Array();//названия и порядок костей второй группы без расширения(.jpg)
...
*/
function rand() {
    let asmas1 = new Array();
    let asmas2 = new Array();
    for (let i = 0; i < 16; i++) {
        while (true) {
            x = Math.round(Math.random() * 100 / 6.25);
            if (asmas1[x] != true && x != 0) //если номер кости не был случайно сгенерирован
            {
                images1[i] = x;
                asmas1[x] = true;
                break;
        ...
        while (true) {
            ...
            if (asmas2[x1] != true && x1 != 0) //если номер кости не был случайно сгенерирован
            {
                images2[i] = x1;
                asmas2[x1] = true;
                break;
...
*/
function images(obj) {
    m = document.getElementById("game");
