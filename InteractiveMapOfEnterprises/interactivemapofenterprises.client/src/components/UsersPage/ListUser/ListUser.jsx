...
const ListUser = ({ data, setEditUser, deleteAsync, children }) => {
    ...
    return (
        <>
            <ActionConfirmationBox active={isActiveDeleteConfirmationBox} message={`Удалить ${data.name}?`} onConfirm={() => {
                setIsActiveDeleteConfirmationBox(false);
                deleteAsync(data.id);
