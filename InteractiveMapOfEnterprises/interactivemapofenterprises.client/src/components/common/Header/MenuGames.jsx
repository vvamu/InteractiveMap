    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", alignItems: "baseline", justifyContent: "center", marginRight: "10px" }}>
            ...
            <div>
                ...
                {
                        !dropdownOpen ? null : (
                            <ul style={{backgroundColor:"white" , borderRadius:"5px",marginTop:"10px",padding:"5px 0px",} }>
                                <li><Link onClick={() => { toggle() }} to="/games/memo" style={{ margin: "10px", cursor: "pointer" }}>«Memory»</Link></li>
                                <li><hr/></li>
                                <li><Link onClick={() => { toggle() }}  to="/games/puzzle" style={{ margin: "10px", cursor: "pointer" }}>«Pazzle»</Link></li>
                        </ul>)
                }    
                </div>
            </div>
