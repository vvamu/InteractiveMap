...
const MenuAuthorized = ({ currentUser, changeUser, isOpenStatus }) => {
    ...
    return (
        <span className={isOpenStatus ? "Navbar-links" : "Navbar-links Navbar-links--closed"}>
            ...
            {currentUser.roles != "Administrator" ? null : <li><Link to={ApplicationUrl.User.app.get} style={{ marginRight: "10px", cursor: "pointer" }}>Пользователи</Link></li>}

            <li><Link to={ApplicationUrl.User.app.get + currentUser.id} style={{ marginRight: '10px', cursor: 'pointer', display: "flex", alignItems: "center", gridGap: "5px" }}>
